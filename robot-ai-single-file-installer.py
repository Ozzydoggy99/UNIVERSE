#!/usr/bin/env python3
"""
Robot AI Single-File Installer

This is a completely self-contained installer that sets up a web dashboard
to interact with your robot. Upload just this one file to your robot, run it,
and you'll have a full-featured dashboard interface.
...
# The comprehensive dashboard HTML file
DASHBOARD_HTML = """
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="card">
                ...
                <div class="config-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="robot-secret" placeholder="Enter secret key">
                    </div>
                </div>
                <div class="form-group">
...
def print_banner():
    ...
    print("=" * 60)
    print("Robot AI Single-File Installer")
    print("=" * 60)
    print("This script will set up the Robot AI dashboard on your robot.")
    print("Version: 1.0.0")
    print("=" * 60)
...
def create_dashboard_file():
    ...
    try:
        ...
        tmp_dir = tempfile.mkdtemp(prefix="robot-ai-")
        
        # Save the dashboard HTML
        dashboard_path = os.path.join(tmp_dir, "dashboard.html")
...
class DashboardHandler(http.server.SimpleHTTPRequestHandler):
    """HTTP request handler for serving the dashboard"""
    
    def __init__(self, *args, **kwargs):
        self.dashboard_dir = kwargs.pop("dashboard_dir")
    ...
    def do_GET(self):
        ...
        # Redirect to the dashboard file in the temp directory
        file_path = os.path.join(self.dashboard_dir, os.path.basename(self.path))
...
def start_dashboard_server(dashboard_dir):
    """Start a web server to serve the dashboard"""
    logger.info(f"Starting dashboard server on port {WEB_PORT}")
    
    try:
        # Create a request handler with the dashboard directory
        handler = lambda *args, **kwargs: DashboardHandler(*args, dashboard_dir=dashboard_dir, **kwargs)
        ...
        logger.info(f"Dashboard server started at: http://localhost:{WEB_PORT}/")
        return httpd
    except Exception as e:
...
def open_dashboard_in_browser():
    ...
    try:
        ...
        logger.info(f"Please open this URL manually: http://localhost:{WEB_PORT}/")
        return False
...
def main():
    ...
    print(f"Dashboard is now available at: http://localhost:{WEB_PORT}/")
