...
export function registerZone104WorkflowRoute(app: express.Express) {
  ...
  const handleZone104Workflow = async (req: express.Request, res: express.Response) => {
    ...
    try {
      ...
      // Find specifically needed points using EXACT IDs from the robot
      ...
      for (let i = 0; i < workflowSteps.length; i++) {
        ...
        // Safety: Manual joystick movements are not supported for automatic workflows
        // Keeping this section commented as reference only
